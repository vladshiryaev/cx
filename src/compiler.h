...
public:
    ...
    virtual bool link(const Config&, const char* exec, const FileStateList& objList, const FileStateList& libList) = 0;
    virtual bool makeLibrary(const Config&, const char* name, const FileStateList& objList) = 0;
...
public:
    ...
    bool link(const Config&, const char* exec, const FileStateList& objList, const FileStateList& libList) override;
    bool makeLibrary(const Config&, const char* name, const FileStateList& objList);
